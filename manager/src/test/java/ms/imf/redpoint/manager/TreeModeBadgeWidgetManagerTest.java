...
public class TreeModeBadgeWidgetManagerTest {
    ...
    private static class BadgeWidget extends ms.imf.redpoint.manager.BadgeWidget<Remind> {
        BadgeWidget(BadgeManager<Remind> remindHandleManager) { super(remindHandleManager); }
